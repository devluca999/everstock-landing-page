    ...
    <header style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 20, padding: "clamp(12px,1.8vh,20px) clamp(16px,3vw,40px)", pointerEvents: "none" }}>
      <div
        style={{
          ...
          borderColor: scrolled ? "var(--es-edge)" : "transparent",
          background: scrolled ? "var(--es-panel)" : "transparent",
          backdropFilter: scrolled ? "blur(18px) saturate(132%)" : "blur(0px)",
          WebkitBackdropFilter: scrolled ? "blur(18px) saturate(132%)" : "blur(0px)",
          boxShadow: scrolled ? "inset 0 1px 0 var(--es-lip)" : "none",
          pointerEvents: "auto",
          transition:
